...
$string['config_smtpcustomsecure'] = 'SMTP security';
$string['config_smtpcustomsecuredesc'] = 'If SMTP server requires secure connection, specify the correct protocol type.';
